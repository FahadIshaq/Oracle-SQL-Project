 ...
 * @author FAHAD_ISHAQ
 */
public class View_Laundry extends javax.swing.JFrame {

    /**
     * Creates new form View_Laundry
     */
    public View_Laundry() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Customer_ID", "Pieces", "Bill"
            }
        ));
        table.setEnabled(false);
        jScrollPane2.setViewportView(table);

        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 100, 900, 270));

        jLabel10.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel10.setText("Search by CNIC");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 410, -1, 20));
        ...
        getContentPane().add(cnic, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 410, 150, -1));
        ...
        getContentPane().add(find, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 410, -1, -1));
        ...
        getContentPane().add(clear, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 410, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_Laundry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new View_Laundry().setVisible(true);
            }
        });
    }
