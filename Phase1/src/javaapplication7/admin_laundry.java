 ...
 * @author FAHAD_ISHAQ
 */
public class admin_laundry extends javax.swing.JFrame {

    /**
     * Creates new form admin_laundry
     */
    public admin_laundry() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication7/laundryll.png"))); // NOI18N
    ...
    private void FINDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_FINDActionPerformed
        // TODO add your handling code here:
        dispose();
        View_Laundry delete=new View_Laundry();
    ...
    private void DELETEActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DELETEActionPerformed
        ...
        Delete_Laundary delete=new Delete_Laundary();
        delete.setLocationRelativeTo(null);
        delete.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(admin_laundry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new admin_laundry().setVisible(true);
            }
        });
    }
